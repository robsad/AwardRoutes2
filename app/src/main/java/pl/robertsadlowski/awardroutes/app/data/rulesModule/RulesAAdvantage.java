...
import pl.robertsadlowski.awardroutes.app.data.airports.AirportsAAdvantage;
...
public class RulesAAdvantage implements RulesModule {
    ...
    public RulesAAdvantage(Map<String, List<Connection>> connectionsByOrigin,
        ...
        System.out.println("milesTableDomestic " + milesTableDomestic);
    }
